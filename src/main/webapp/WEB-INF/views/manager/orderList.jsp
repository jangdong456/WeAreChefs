										...
										<tbody id="cancelList">
											<c:forEach items="${cancelOrderList}" var="list">
												<tr style="cursor:pointer;">
													<td onclick="location.href='/manager/orderDetail?order_num=${list.order_num}'">
														${list.order_date}</td>
													<td onclick="location.href='/manager/orderDetail?order_num=${list.order_num}'">
														${list.order_num}</td>
													<td onclick="location.href='/manager/orderDetail?order_num=${list.order_num}'">
													...
													<td onclick="location.href='/manager/orderDetail?order_num=${list.order_num}'">
														${list.order_price}</td>
													<td onclick="location.href='/manager/orderDetail?order_num=${list.order_num}'">
														${list.order_status}</td>
													<td>
														<div class="form-button-action">
															<button id="cancelOk${list.order_num}" data-cancel="${list.order_num}" type="button"
																data-bs-toggle="tooltip" title="결제 취소 승인" class="btn btn-link btn-primary btn-lg"
																data-original-title="Edit Task">
																<i class="fas fa-check"></i>
															</button>
															<button id="cancelNo${list.order_num}" data-cancel="${list.order_num}" type="button"
																data-bs-toggle="tooltip" title="결제 취소 거절" class="btn btn-link btn-danger"
