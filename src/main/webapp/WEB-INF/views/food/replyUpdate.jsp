<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<textarea class="form-control areaContext" cols="30" rows="8" id="updateContent"
			data-reply-num="${dto.food_reply_num}" data-reply-writer="${dto.member_id}">${dto.reply_content}</textarea>
