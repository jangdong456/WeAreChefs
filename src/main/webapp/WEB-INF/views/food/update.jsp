            ...
            <div class="container py-5">
                ...
                <form action="/food/update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control w-50" readonly id="foodName"
                            value="${map.dto.food_name}">
                    </div>

                    <div class="form-group">
                        <label class="form-label mt-3 mr-3">* 카테고리</label>
                        <input type="text" class="form-control w-50" readonly id="foodCategory"
                            value="${map.dto.food_category}">
                    </div>

                    <div class="form-group">
                        <label class="form-label mt-3 mr-3">* 재고</label>
                        <input type="text" class="form-control w-50" readonly id="foodStock"
                            value="${map.dto.food_stock}">
                    </div>

                    <div class="form-group">
                        <label class="form-label mt-3 mr-3">* 판매가</label>
                        <input type="text" class="form-control w-50" readonly id="foodPrice"
                            value="${map.dto.food_price}">
                    </div>
                    ...
                    <div class="form-group" id="imgDiv">
                        <input type="hidden" id="foodNum" name="storeImgFileDTO.file_name"
                            value="${map.dto.storeImgFileDTO.file_name}">
