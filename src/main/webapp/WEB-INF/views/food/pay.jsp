                            ...
                            <div class="col-md-12 col-lg-6 col-xl-7">
                                ...
                                <div class="form-item">
                                    ...
                                    <input type="text" class="form-control" readonly
                                        value="${orderMember.member_nickname}">
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                style="flex: 1 1 0; max-width: 60%; background-color: transparent;"
                                                id="postInput" readonly>
                                            <div class="input-group-append">
                                                <button class="btn border-secondary text-uppercase text-primary"
                                                    type="button" style="margin-left: 10px;" id="postSearch">우편번호
                                                    검색하기</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-item">
                                    ...
                                    <input type="text" class="form-control" id="firstAddress" readonly
                                            ...
                                            <c:forEach items="${list}" var="a">
                                                <c:forEach items="${a.foodDTO}" var="f">
                                                    <tr>
                                                        ...
                                                        <td class="py-5 foodInfo" data-food-num="${f.food_num}">
                                                            ${a.cart_count}</td>
                                                        <td class="py-5 totalPrice"
                                                            data-total-notice="${f.food_price*a.cart_count}">
                                                            ${f.food_price*a.cart_count}원</td>
                                                    </tr>
                                                </c:forEach>
                                            </c:forEach>
                                            <tr>
