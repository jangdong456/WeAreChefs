							...
							<form method="get" action="./list">
								<div style="display: flex; justify-content: space-between; align-items: center;">
										<div style="text-align: center; flex-grow: 1;">
												...
												<input type="search" name="search" style="height: 40px; width: 500px; padding: 5px; border-radius: 5px; border: 1px solid #ccc; margin-left: 10px;">
										...
										<c:if test="${member.member_lev > 0}">
												<div>
														<a href="/board/${page}/add" class="btn border-secondary rounded-pill px-4 py-3 text-primary ml-1" type="button">add</a>
												</div>
										</c:if>
								</div>
						</form>
